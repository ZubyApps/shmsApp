...
class SmsDetailsResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'smsDetails'   => 'Dear ' . $this->visit->patient->first_name . ' ' . $this->visit->patient->last_name . ', please kindly clear your hospital bill (N' .number_format($outstanding). ') incurred on ' . (new Carbon($this->visit->created_at))->format('d/m/Y') . '. Kindly send to Monie Point Nzube Okoye 5496896686 or visit the hospital',
        ];
    }
}
