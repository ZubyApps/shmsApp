...
class InvestigationReportService
{
    ...
    public function getInvestigationsSummary(DataTableQueryParams $params, $data)
    {
        // $orderBy        = 'created_at';
        $orderDir       =  'desc';
        ...
        $query = $this->resource->whereRelation('resourceSubCategory.resourceCategory', 'name', '=', 'Investigations')
    ...
    public function getInvestigationsTransformer(): callable
    {
