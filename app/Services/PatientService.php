...
class PatientService
{
    ...
    // ->selectRaw("SUM(CASE WHEN DATE(date_of_birth) >= DATE_SUB(CURDATE(), INTERVAL 3 MONTH) THEN 1 ELSE 0 END) AS zeroTo3m, SUM(CASE WHEN (DATE(date_of_birth) < DATE_SUB(CURDATE(), INTERVAL 3 MONTH) AND DATE(date_of_birth) >= DATE_SUB(CURDATE(), INTERVAL 12 MONTH)) THEN 1 ELSE 0 END) AS threeTo12m, SUM(CASE WHEN (DATE(date_of_birth) < DATE_SUB(CURDATE(), INTERVAL 12 MONTH)) AND YEAR(date_of_birth) >= {$currentDate->subYears(5)->year}) THEN 1 ELSE 0 END) AS oneTo5yrs, SUM(CASE WHEN (YEAR(date_of_birth) < {$currentDate->subYears(5)->year} AND YEAR(date_of_birth) >= {$currentDate->subYears(13)->year}) THEN 1 ELSE 0 END) AS fiveto13yrs, SUM(CASE WHEN (YEAR(date_of_birth) < {$currentDate->subYears(13)->year} AND YEAR(date_of_birth) >= {$currentDate->subYears(18)->year}) THEN 1 ELSE 0 END) AS thirteenTo18yrs, SUM(CASE WHEN (YEAR(date_of_birth) < {$currentDate->subYears(18)->year} AND YEAR(date_of_birth) >= {$currentDate->subYears(48)->year}) THEN 1 ELSE 0 END) AS eighteenTo48yrs, SUM(CASE WHEN (YEAR(date_of_birth) < {$currentDate->subYears(48)->year} AND YEAR(date_of_birth) >= {$currentDate->subYears(63)->year}) THEN 1 ELSE 0 END) AS fortyEightTo63yrs, SUM(CASE WHEN (YEAR(date_of_birth) < {$currentDate->subYears(63)->year}) THEN 1 ELSE 0 END) AS above63yrs , sex"
    // )
