...
class ResourceReportService
{
    ...
    public function getUsedResourcesSummary(DataTableQueryParams $params, $data)
    {
        ...
        //             ->with([
        //                 'resourceSubCategories.resources.prescriptions' => function ($query) use ($data, $current) {
        ...
        //                 }
        //             ])
        //             // ->withCount('resourceSubCategories.resource.prescriptions as prescriptionCount')
