...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('prescriptions', function (Blueprint $table) {
            ...
            $table->foreignIdFor(User::class, 'billed_by')->nullable()->constrained('users')->restrictOnDelete();
            ...
            $table->foreignIdFor(User::class, 'hmo_id')->nullable()->constrained('users')->restrictOnDelete();
