    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
                    ...
                    <div class="form-control mb-2">
                        <div class="row">
                            ...
                            <x-form-div class="col-xl-12">
                                ...
                                <select class="form-select form-select-md" id="resourceCategory" name="resourceCategory">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="{{ $isUpdate ? 'saveResourceSubCategory' : 'createResourceSubCategory' }}Btn" class="btn btn-primary">
