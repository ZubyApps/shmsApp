...
@section('content')
@vite(['resources/css/colourblink.scss','resources/js/investigations.js'])
    ...
    <div class="container mt-5 bg-white">
        ...
        <div>
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <!-- active table -->
                <div class="tab-pane fade" id="nav-inPatients-view" role="tabpanel" aria-labelledby="nav-inPatients-tab" tabindex="0">
                    <div class="py-4">
                ...
                <!-- sponsors table -->
                <div class="tab-pane fade" id="nav-ancPatients-view" role="tabpanel" aria-labelledby="nav-ancPatients-tab" tabindex="0">
                    <div class="py-4 ">
