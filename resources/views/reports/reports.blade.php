...
<div class="container mt-5">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
      ...
      <div class="col d-flex align-items-start">
        <i class="bi bi-lungs-fill me-3 btn btn-outline-primary"></i>
        <div>
      ...
      <div class="col d-flex align-items-start">
        <i class="bi bi-eyedropper me-3 btn btn-outline-primary"></i>
        <div>
      ...
      <div class="col d-flex align-items-start">
        <i class="bi bi-capsule me-3 btn btn-outline-primary"></i>
        <div>
      ...
      <div class="col d-flex align-items-start">
        <i class="bi bi-hospital me-3 btn btn-outline-primary"></i>
        <div>
          <h3 class="fw-bold mb-0 fs-4 text-primary">Hospital/Other</h3>
          <p>Paragraph of text beneath the heading to explain the heading.</p>
        </div>
      </div>
      <div class="col d-flex align-items-start">
      ...
      <div class="col d-flex align-items-start">
        <i class="bi bi-minecart-loaded me-3 btn btn-outline-primary"></i>
        <div>
