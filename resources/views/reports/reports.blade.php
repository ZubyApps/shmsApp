...
<div class="container mt-5">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fw-bold mb-0 fs-4 text-primary">Investigations</h3>
          <p>Investigation and Laboratory report summaries.</p>
        </div>
      </div>
      <div class="col d-flex align-items-start">
        ...
        <div>
          ...
          <p>Medications and Consumables report summaries.</p>
        </div>
      </div>
      <div class="col d-flex align-items-start">
        ...
        <div>
          ...
          <p>Hospital services and Other services report summaries.</p>
        </div>
      </div>
      <div class="col d-flex align-items-start">
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          ...
          <p>Report summaries for Resources covering other areas of interest.</p>
        </div>
      </div>
      <div class="col d-flex align-items-start">
