...
@section('content')
@vite(['resources/js/hospitalAndOthersReports.js'])
    ...
    <div>
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active" id="nav-summary" role="tabpanel" aria-labelledby="nav-summary-tab" tabindex="0">
                <div class="py-2">
                    <h5 class="card-title py-4">Summary of Hospital/Other Services</h5>
                    <x-form-div class="col-xl-8 py-3 datesDiv">
                        ...
                        <x-form-input type="month" name="hospitalAndOthersMonth" id="hospitalAndOthersMonth" />
                        <button class="input-group-text searchHospitalAndOthersByMonthBtn">Search</button>
                    </x-form-div>
