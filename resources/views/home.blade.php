            ...
            <div class="vh-50 p-5 mb-4 cover-image">
                <div class="col-lg-6 px-0 display-4">
                    ...
                    <div class="">
                        ...
                        <br>
                        <a href="{{ $staffD === 'Doctor' || $staffD === 'Lab Tech' || $staffD === 'HMO Officer' || $staffD === 'Bill Officer' || $staffA > 4 ? '/investigations' : '' }}" class="btn btn-outline-primary mx-1"><i class="bi bi-eyedropper" aria-hidden="true"> Investigations</i></a>
                        ...
                        <a href="{{ $staffA > 4 ? '/communication-services' : '' }}" class="btn btn-outline-primary fw- mx-1"><i class="bi bi-broadcast-pin"> Communication Services</i></a>
                    </div>
                    <br>
