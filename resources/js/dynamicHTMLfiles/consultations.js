...
const regularReviewDetails = (iteration, numberConverter, count, length, line, viewer, isDoctorDone, closed, isHistory = 0, visitIteration) => {
    ...
    return `
                ...
                <div class="collapse mb-2 reviewDiv" id="collapseExample${usableIteration}" style="">
                    ...
                    <div class="d-flex justify-content-center mb-1 text-outline-primary input-group-text text-center" id="collapseReview" data-bs-toggle="collapse" href="#collapseExample${usableIteration}" role="button" aria-expanded="true" aria-controls="collapseExample">
...
const AncPatientReviewDetails = (iteration, numberConverter, count, length, line, viewer, isDoctorDone, closed, isHistory = 0, visitIteration) => {
    const usableIteration = isHistory ? visitIteration+'-'+iteration : iteration
    return `
                <div class="btn btn-primary d-flex justify-content-center mb-1 text-outline-primary input-group-text text-center collapseConsultationBtn" id="collapseReview" data-bs-toggle="collapse" href="#collapseExample${usableIteration}" role="button" aria-expanded="true" aria-controls="collapseExample" data-goto="#goto${usableIteration}">
